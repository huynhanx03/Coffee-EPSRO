...
const OrderItem = () => {
    ...
    return (
        <TouchableOpacity onPress={() => navigation.navigate('OrderDetail')} className='my-2 mx-4 flex'>
            <View className='px-2 rounded-lg shadow-xl bg-white'>
                <View className='flex-row space-x-5'>
                    ...
                    <View className='my-2 flex-1'>
                        ...
                        <View className='flex-row items-center space-x-5'>
                            ...
                            <Text className='text-base italic'>1</Text>
                        </View>
